...
console.log('🔧 A reescrever AppLayout.tsx com sidebar persistente...');

const filePath = path.join(__dirname, 'src/layout/AppLayout.tsx');
...
console.log('🎉 Sidebar agora mantém estado entre sessões.');
