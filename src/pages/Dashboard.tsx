  ...
  return (
    ...
    >
      ...
      {alerts.length > 0 && (
        ...
        >
          <h2 style={{ marginBottom: "1rem", color: theme.colors.danger }}>
            Alertas
          </h2>
          {alerts.map((a, i) => (
      ...
      <Widget
        ...
        items={recentIncidentes}
        field="titulo"
        theme={theme}
      />
      <Widget
        title="Últimos Pagamentos"
        items={recentPagamentos}
        field="descricao"
        theme={theme}
      />
      <Widget
        title="Últimas Mensagens"
        items={recentMensagens}
        field="titulo"
        theme={theme}
      />
      <Widget
      ...
      />
      <Widget
        title="Últimos Itens de Inventário"
        items={recentInventario}
        field="nome"
        theme={theme}
      />
      <Widget
        title="Últimos Proprietários"
        items={recentOwners}
        field="nome"
        theme={theme}
      />
