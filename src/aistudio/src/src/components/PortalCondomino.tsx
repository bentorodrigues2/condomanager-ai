...
export function PortalCondomino({
  ...
  const handleSendMsgToAdmin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      alert("A sua mensagem foi enviada à Administração! Pode acompanhar o estado no painel.");
    }, 1200);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      {/* --- FLOATING "CONTACTAR ADMINISTRAÇÃO" BUTTON --- */}
      {loggedUser.role === "USER" && (
        <>
          ...
          >
            ...
            <span className="text-xs uppercase tracking-wider">Contactar Administração</span>
          </button>
              ...
              <div className="w-full max-w-md bg-white h-full shadow-2xl p-6 flex flex-col justify-between animate-slide-left overflow-y-auto">
                <div>
                  <div className="flex justify-between items-center border-b border-slate-100 pb-4 mb-6">
                    <div>
                      <h3 className="text-base font-bold text-slate-800">Canal Direto com Administração</h3>
                      <p className="text-[10px] text-slate-500">Mensagens urgentes, avarias ou dúvidas regulatórias</p>
                    </div>
                    <button
                  ...
                  <form onSubmit={handleSendMsgToAdmin} className="space-y-4">
                    <div className="flex flex-col">
                      ...
                      <input
                        ...
                        placeholder="Ex: Avaria no portão, Ruído nas escadas..."
                    ...
                    <div className="flex flex-col">
                      <label className="text-[10px] font-bold text-slate-500 uppercase mb-1">Anexo / Foto (WebP Automático)</label>
                      <div className="border-2 border-dashed border-slate-200 rounded-xl p-4 text-center cursor-pointer hover:bg-slate-50 transition-colors" onClick={() => msgFileRef.current?.click()}>
                        ...
                        <p className="text-[9px] text-slate-400 mt-0.5">O ficheiro será comprimido e guardado como WebP</p>
                        <input
                          type="file"
                          ref={msgFileRef}
                        ...
                        <div className="mt-3 bg-emerald-50 border border-emerald-100 p-2.5 rounded-lg flex items-center justify-between text-[10px]">
                          <div className="flex items-center space-x-2">
                            ...
                            <div>
                              ...
                              <span className="text-slate-500 block">De: {anexoSizeOriginal} → WebP: {anexoSizeWebP} (Otimizado)</span>
                            </div>
                          </div>
                          <button
                            type="button"
                    ...
                    >
                      {msgSending ? "A enviar..." : "Enviar Solicitação"}
                    </button>
                  </form>
                </div>

                <div className="text-[10px] text-slate-400 text-center border-t border-slate-100 pt-4 mt-6">
                  Sempre em conformidade com o regulamento do prédio {predio.nome || "Ativo"}.
                </div>
              </div>
            </div>
          )}
            ...
            <form onSubmit={handleSendPaymentProof} className="p-6 space-y-4">
              <div className="flex flex-col">
                ...
                >
                  ...
                  <p className="text-[9px] text-slate-400 mt-1">Será automaticamente convertido em WebP para poupança de espaço</p>
                  <input
                    type="file"
                    ref={payFileRef}
              ...
              {paymentFile && (
                <div className="bg-slate-50 border border-slate-100 rounded-xl p-3 text-[10px] text-slate-600 flex items-center justify-between">
                  <span className="font-semibold text-emerald-700">
                    Original ({paymentOriginalSize}) → Convertido WebP ({paymentWebPSize})
                  </span>
                  <span className="bg-emerald-100 text-emerald-800 font-bold px-2 py-0.5 rounded">CONVERSÃO WEBP ACTIVA</span>
                </div>
              )}
            ...
            <div className="p-6 space-y-4">
              <div className="border border-purple-100 bg-purple-50/40 rounded-xl p-4 text-xs text-purple-950 space-y-3">
                ...
                <div className="space-y-2 text-slate-700 font-sans leading-relaxed">
                  ...
                  <p>Em nome de toda a equipa do <strong>CondoManager AI</strong> e da Administração do seu condomínio, desejamos-lhe um excelente dia de aniversário, repleto de felicidade, saúde e harmonia!</p>
                  <p>Agradecemos imenso por fazer parte da nossa comunidade residencial e por nos ajudar a tornar o nosso edifício num lugar cada vez melhor para viver.</p>
                  <p>Muitos parabéns!</p>
              ...
              <button
                onClick={() => {
                  ...
                  alert("E-mail de aniversário disparado e entregue com sucesso!");
                }}
          ...
          <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden animate-zoom-in border border-emerald-200">
            ...
            <div className="p-6 space-y-4">
              <div className="border border-emerald-100 bg-emerald-50/30 rounded-xl p-4 text-xs text-slate-800 space-y-3">
                ...
                <p><strong>Assunto:</strong> Confirmação de Conta – Condomínio</p>
                <hr className="border-emerald-100" />
                <div className="space-y-2 text-slate-700 font-sans leading-relaxed">
                  <p>Olá <strong>{welcomeMailModal.fracao.proprietario.nome}</strong>,</p>
                  <p>A sua conta foi criada com sucesso. Pode aceder à sua área pessoal <a href="#" className="text-emerald-600 font-bold underline cursor-pointer">AQUI</a>.</p>
                  
                  <div className="bg-white border border-slate-200 p-3 rounded-lg font-mono-custom text-[11px] text-slate-800 space-y-1">
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Dados de Acesso Provisórios:</p>
                    <p><strong>Utilizador:</strong> {welcomeMailModal.fracao.proprietario.email}</p>
                    <p className="text-indigo-600"><strong>Password Provisória:</strong> {welcomeMailModal.pass}</p>
                  </div>

                  <p className="text-slate-500 text-[10px] italic pt-2">Com os meus cumprimentos,</p>
                  <p className="text-slate-600 text-xs font-bold">O Administrador do Condomínio</p>
                  <p className="text-slate-400 text-[10px] font-bold pt-1">Powered by CondoManager AI</p>
                </div>
              </div>
              <button
                onClick={() => {
                  setWelcomeMailModal(null);
                  alert(`E-mail de boas-vindas com password provisória provida disparada com sucesso!`);
                }}
