...
const condoManagerLogo = "/marca/18-versao-horizontal-1.webp";
...
export default function App() {
  ...
  if (browserIsLoggedOut) {
    ...
    const handleAuthenticateBrowser = (forceSuccess: boolean = false) => {
      ...
      const cleanEmail = (browserEmail || "").trim().toLowerCase();
      if (!cleanEmail) {
        setLoginErrorMessage("Por favor, introduza o e-mail de utilizador.");
        return;
      }

      if (!forceSuccess && !browserPassword) {
        setLoginErrorMessage("Por favor, introduza a palavra-passe.");
        return;
      }

      if (!forceSuccess && browserPassword === "errada") {
        setLoginErrorMessage("❌ Palavra-passe incorreta.");
        handleFailedAttempt();
        return;
      }
      ...
      if (!account) {
        setLoginErrorMessage("❌ Por favor, introduza um e-mail válido.");
        handleFailedAttempt();
        return;
      }
      ...
      createSecurityLog(email, "LOGIN_SUCCESS", `Login efetuado com sucesso no perfil ${role} (${nome}). IP auditado e verificado.`);
      setUserSecurityMap(prev => ({
        ...prev,
        [email]: {
          ...userSec,
        ...
        setBrowserBiometricProgress(prev => {
          if (prev >= 100) {
            ...
            setTimeout(() => {
              ...
              handleAuthenticateBrowser(true);
            }, 300);
            return 100;
          }
          return prev + 25;
        ...
        <div className="max-w-[380px] w-full bg-slate-900/95 border border-slate-800 p-4 sm:p-5 rounded-2xl shadow-2xl backdrop-blur-xl my-auto text-center space-y-3 relative overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center pt-1">
            <div className="h-20 sm:h-24 w-full flex items-center justify-center overflow-visible my-1">
              <img 
                src={whiteLabelLogo || "/marca/02-versao-horizontal.webp"} 
                alt="CondoManager AI" 
                ...
                <div className="bg-emerald-950/70 border border-emerald-500/50 p-3 rounded-xl space-y-2 text-center">
                  ...
                  <div className="pt-2 border-t border-emerald-500/30 space-y-2 text-left">
                    ...
                    <button
                      ...
                      className="w-full border-2 border-emerald-500 bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 active:scale-95 text-white font-bold py-2.5 px-4 rounded-xl text-xs cursor-pointer transition-all shadow-md active:ring-2 active:ring-emerald-400 select-none flex items-center justify-center gap-2"
                    >
            ...
            <div className="space-y-2.5 text-left pt-0.5">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="ex: admin@condomanager.pt"
                    className="w-full bg-slate-950 border border-slate-800 text-xs rounded-lg p-2 pl-8 font-medium text-white focus:outline-none focus:border-emerald-500"
                  />
                  <i className="fa-solid fa-envelope absolute left-2.5 top-2.5 text-slate-500 text-xs"></i>
                </div>
              ...
              <div className="pt-1 space-y-1.5">
                <button
                  ...
                  onClick={() => handleAuthenticateBrowser()}
  ...
  return (
    <div className={`h-screen w-screen flex overflow-hidden relative transition-all duration-300 ${theme === "dark" ? "bg-[#0b0f19] text-slate-100" : "bg-slate-50 text-slate-800"}`}>
      ...
      <aside className={`h-full flex flex-col select-none shrink-0 z-30 no-print transition-all duration-300 ${
        ...
        mobileMenuOpen ? "fixed inset-y-0 left-0 w-72 translate-x-0 shadow-2xl z-50" : "fixed inset-y-0 left-0 -translate-x-full lg:static lg:translate-x-0"
      } ${
        ...
        <div className="w-full border-b border-slate-800 shrink-0 overflow-hidden bg-slate-900/40">
          <div className="w-full h-20 flex items-center justify-center p-2 relative overflow-hidden">
            ...
            >
              <img 
                src={whiteLabelLogo || "/marca/18-versao-horizontal-1.webp"} 
                alt="CondoManager AI" 
                className={`w-full h-full object-contain select-none transition-transform duration-300 drop-shadow-xl ${sidebarCollapsed ? "scale-90" : "scale-135 sm:scale-145 max-w-[280px]"}`} 
                referrerPolicy="no-referrer"
              />
            </div>
          </div>
        ...
        <nav className="flex-grow px-3 py-4 space-y-1.5 overflow-y-auto">
          ...
          >
            ...
            <span className={`${sidebarCollapsed ? "lg:hidden" : ""}`}>Dashboard da Administração</span>
          </button>

          {/* Cadastro de Prédio */}
          <button 
            id="sidebar-item-predios"
            onClick={() => selectSection("predios")}
          ...
          >
            ...
            <span className={`${sidebarCollapsed ? "lg:hidden" : ""}`}>Cadastro de Prédio</span>
          </button>
          ...
          >
            <img src="/modulos/75-mensagem.png" alt="Mensagens" className="w-5 h-5 object-contain shrink-0" />
            <span>Mensagens</span>
          </button>
          ...
          <div className="space-y-1">
            ...
            >
              <div className="flex items-center gap-2.5">
                <img src="/modulos/28-intervencao.png" alt="Vistorias" className="w-5 h-5 object-contain shrink-0" />
          ...
          <div className="space-y-1">
            ...
            >
              <div className="flex items-center gap-2.5">
                <img src="/modulos/57-quota.png" alt="Financeiro" className="w-5 h-5 object-contain shrink-0" />
          ...
          <div className="space-y-1">
            ...
            >
              <div className="flex items-center gap-2.5">
                <img src="/modulos/23-contrato.png" alt="Jurídico" className="w-5 h-5 object-contain shrink-0" />
          ...
          <div className="space-y-1">
            ...
            >
              <div className="flex items-center gap-2.5">
                <img src="/modulos/73-mensagem-global.png" alt="Central de Comunicações" className="w-5 h-5 object-contain shrink-0" />
          ...
          >
            <img src="/modulos/87-ia-ativa.png" alt="IA" className="w-5 h-5 object-contain shrink-0" />
      ...
      <main className={`flex-grow w-full flex flex-col h-full overflow-hidden relative transition-all duration-300 ${theme === "dark" ? "bg-[#0b0f19]" : "bg-slate-50"}`}>
        {/* Header superior */}
        <header className={`h-16 px-3 sm:px-6 md:px-8 flex items-center justify-between shrink-0 z-10 no-print transition-all duration-300 ${theme === "dark" ? "bg-[#111827] border-b border-slate-800 text-slate-100" : "bg-white border-b border-slate-200 text-slate-800"}`}>
          <div className="flex items-center space-x-2 sm:space-x-3 overflow-hidden pr-2">
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-xl bg-slate-800 hover:bg-slate-700 active:bg-slate-900 text-emerald-400 border border-slate-700 flex items-center gap-1.5 text-xs font-bold transition-all cursor-pointer shrink-0 shadow-sm"
