            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-bold px-3 py-2 rounded-xl transition-all cursor-pointer flex items-center gap-1.5"
                >
                  <i className="fa-solid fa-file-pdf text-red-500"></i>
                  <span>Exportar Quotas PDF</span>
                </button>
              </div>
            </div>
