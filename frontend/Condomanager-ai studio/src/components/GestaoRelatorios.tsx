...
export function GestaoRelatorios({ predio, loggedUser, movimentos = [], fracoes = [] }: GestaoRelatoriosProps) {
  ...
  return (
    <div className="space-y-6 animate-fadeIn" id="relatorios-module">
      {/* Description header */}
      <div className="bg-gradient-to-r from-blue-500/10 to-emerald-500/10 p-6 rounded-2xl border border-blue-500/15">
              ...
              <div className="flex flex-wrap justify-between items-start gap-4 border-b border-slate-100 pb-4">
                ...
                <div className="flex space-x-2 no-print">
                  <button 
                    ...
                    className="bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 font-bold text-[10px] px-3 py-1.5 rounded-lg transition-colors cursor-pointer"
                  >
                    <i className="fa-solid fa-file-pdf mr-1"></i> Descarregar PDF
                  </button>
                  <button 
